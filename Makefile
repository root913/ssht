...
define build
	...
	@GOARCH=$(2) GOOS=$(1) GO111MODULE=on go build -ldflags '$(LDFLAGS)' -a -tags netgo -o bin/${BINARY_NAME}_$(1)_$(2)$(3)
	@printf "\e[38;5;49m%-5s    \e[38;5;29m%s%s\e[0m\n\n" "Finished" bin/${BINARY_NAME}_$(1)_$(2) $(3)
endef
...
clean:	## Clean after build
	go clean
	find bin -type f -name "${BINARY_NAME}_*" -delete -print
